...
<%
	...
	int num = ((Integer) request.getAttribute("adminNum")).intValue();
...
<body>
	...
	<div class="container">
		<form name="newUpdate"
			action="adminUpdateAction.do?num=${notice.num }&pageNum=<%=nowpage%>"
			...
			<c:choose>
			<c:when test="${sessionId != null && sessionId eq 'admin'}">
			<div class="form-group row">
